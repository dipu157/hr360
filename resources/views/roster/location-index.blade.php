...
@section('pagetitle')
    <h2 class="no-margin-bottom">Location Information</h2>
@endsection
@section('content')
...
{{--    <script type="text/javascript" src="{!! asset('assets/js/jquery.datetimepicker.js') !!}"></script>--}}
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="pull-left">
                    <button type="button" class="btn btn-shift btn-success" data-toggle="modal" data-target="#modal-new-location"><i class="fa fa-plus"></i>New Location</button>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-12" style="overflow-x:auto;">
                <table class="table table-bordered table-hover table-striped" id="locations-table">
    ...
    @include('roster.modals.add-duty-location')
