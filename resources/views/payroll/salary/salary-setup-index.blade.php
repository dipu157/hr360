...
@section('pagetitle')
    <h2 class="no-margin-bottom">Employee Salery Setup</h2>
@endsection
@section('content')
            ...
            <div class="col-md-11">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-inline" id="search-form" method="get" action="{{ route('payroll/salarySetupIndex') }}">
    ...
    @include('payroll.salary.modals.add.salary-set')
