...
@section('pagetitle')
    <h2 class="no-margin-bottom">Arear Setup</h2>
        ...
        <div class="row justify-content-left">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('payroll/arearSetupPost') }}" >
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="amount" class="col-sm-4 col-form-label text-md-right">Arear Amount</label>
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <form class="form-inline" method="get" action="{{ route('payroll/arearSetupIndex') }}">
