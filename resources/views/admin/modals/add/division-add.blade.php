<div class="modal fade right" id="modal-new-division" tabindex="-1" role="dialog" aria-labelledby="modal-new-division-label"
     aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog modal-info" role="document">
        <!--Content-->
        <form action="{{ url('admin/division/save') }}"  method="post" accept-charset="utf-8">
            {{ csrf_field() }}
