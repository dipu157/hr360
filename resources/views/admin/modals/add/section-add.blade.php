<div class="modal fade right" id="modal-new-section" tabindex="-1" role="dialog" aria-labelledby="modal-new-section-label"
     aria-hidden="true" data-backdrop="false">
    <div class="modal-dialog modal-info" role="document">
        <!--Content-->
        <form action="{{ url('admin/section/save') }}"  method="post" accept-charset="utf-8">
            {{ csrf_field() }}

            <div class="modal-content">
                <!--Header-->
                <div class="modal-header" style="background-color: #17A2B8;">
                    <p class="heading">New Section
                    </p>
                        ...
                        <div class="col-sm-12">
                            <div class="card text-primary bg-gray border-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row" id="md-name">
                                        <label for="name" class="col-sm-4 col-form-label text-md-right">Section Name</label>
                                        <div class="col-sm-8">
                                            <div class="input-group mb-3">
