        ...
        <tr>
            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:15pt;color:#000000; ">Employee List : Status : {!! $status->name !!}<br/>Total Manpower : {!! $employees->count() !!}</span></td>
                    </tr>
                    </thead>
                </table>
            </td>
