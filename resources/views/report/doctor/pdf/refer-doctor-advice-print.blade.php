        ...
        <tr>
            ...
            <td style="width:90%">
                <table style="width:100%" class="order-bank">
                    <thead>
                    <tr>
                        <td style="width:90%;" colspan="2"><span style="text-align:center; border: #000000; font-family:times;font-weight:bold;font-size:12pt;color:#000000; ">OPD Investigation Advised By {!! $doctor->ref_doctor_name !!}
...
@if(!empty($data))
    ...
    <table class="table order-bank" width="90%" cellpadding="2">
        ...
        <tr class="row-line">
            ...
            <th width="300px" style="text-align: left; font-size: 10px; font-weight: bold">Service Name</th>
            <th width="50px" style="text-align: right; font-size: 10px; font-weight: bold">OPD Count</th>
            <th width="100px" style="text-align: right; font-size: 10px; font-weight: bold">OPD Amount</th>
        </tr>
        </thead>
        <tbody>
        ...
        @foreach($data as $i=>$row)
            ...
            <tr>
                ...
                <td width="100px" style="border-bottom-width:1px; font-size:10pt; text-align: right">{!! number_format($row->payable,0) !!}</td>
            </tr>
...
<table class="table order-bank" width="90%" cellpadding="2">
    ...
    <tr class="row-line" >
        ...
        <th width="80px" style="text-align: left; font-size: 10px; font-weight: bold">No of Test</th>
        <th width="80px" style="text-align: left; font-size: 10px; font-weight: bold">Amount</th>
    </tr>
    </thead>
    ...
    @foreach ($num as $sub => $services)
        ...
        <tr>
            @foreach ($services as $row)
                ...
                <td width="80px" style="border-bottom-width:1px; font-size:10pt; text-align: left">{!! $row->opdg !!}</td>
                <td width="80px" style="border-bottom-width:1px; font-size:10pt; text-align: left">{!! $row->payable !!}</td>
