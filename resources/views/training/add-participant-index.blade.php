...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <table class="table table-striped table-hover" id="refresh">
            <thead>
            <tr style="background-color: rgba(17,173,190,0.22)">
                <th style="min-width: 30px;">SL</th>
                <th style="min-width: 300px;">Name</th>
                <th style="min-width: 100px; text-align: right">No of Employee</th>
                <th style="min-width: 100px; text-align: right">Already Trained</th>
                <th style="min-width: 100px; text-align: right">Selected</th>
                <th style="min-width: 100px; text-align: right">Left</th>
            </tr>
            </thead>
            ...
            @foreach($emp_count as $i=>$row)
                ...
                <tr>
                    ...
                    <td style="min-width: 300px;"><a href="{!! url('training/traineeList/'.$row->department_id.'/'.$training->id) !!}">
                            {!! $row->department->name !!}
                        </a></td>
                    ...
                    @foreach($selected as $dept)
                        ...
                        @if($dept->department_id === $row->department_id)
                            <td style="min-width: 100px;">{!!  $dept->selected > 0 ? $dept->selected : 0  !!}</td>
                        @endif
