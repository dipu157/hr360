...
<table class="table order-bank" width="90%" cellpadding="2">
    ...
    {{--</tr>--}}
    <tr>
        <th width="33%" style="text-align: left; font-size: 8px; font-weight: bold">Deputy Manager</th>
        <th width="33%" style="text-align: center; font-size: 8px; font-weight: bold">DGM</th>
        <th width="33%" style="text-align: right; font-size: 8px; font-weight: bold">CFO</th>
    </tr>
    </thead>
</table>
