...
{{--@if(!empty($data))--}}
    ...
    {{--@foreach($employees as $i=>$emp)--}}
        ...
        {{--<div>{!! $emp->employee_id !!} : {!! $emp->professional->personal->full_name !!}</div>--}}
        ...
        {{--<table class="table order-bank" width="90%" cellpadding="2">--}}
            ...
            {{--<tr class="row-line">--}}
                ...
                {{--<th width="50px" style="text-align: left; font-size: 10px; font-weight: bold">Overtime <br/>Date</th>--}}
                {{--<th width="50px" style="text-align: left; font-size: 10px; font-weight: bold">Overtime <br/>Type</th>--}}
                {{--<th width="80px" style="text-align: left; font-size: 10px; font-weight: bold">Duty <br/>Time</th>--}}
                {{--<th width="35px" style="text-align: left; font-size: 10px; font-weight: bold">Overtime <br/>Hour</th>--}}
                {{--<th width="100px" style="text-align: left; font-size: 10px; font-weight: bold">Reason</th>--}}
                {{--<th width="70px" style="text-align: center; font-size: 10px; font-weight: bold">Inserted By</th>--}}
                {{--<th width="70px" style="text-align: center; font-size: 10px; font-weight: bold">Approved <br/>By</th>--}}
                {{--<th width="70px" style="text-align: center; font-size: 10px; font-weight: bold">Finalize<br/>By</th>--}}
            {{--</tr>--}}
            {{--</thead>--}}
            {{--<tbody>--}}
            ...
            {{--@foreach($data as $row)--}}
                {{--@if($emp->employee_id == $row->employee_id)--}}
                    {{--<tr>--}}
                        ...
                        {{--<td width="50px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! \Carbon\Carbon::parse($row->ot_date)->format('d-m-Y') !!}</td>--}}
                        {{--<td width="50px" style="border-bottom-width:1px; font-size:8pt; text-align: center">{!! $row->ot_type == 'S' ? 'Scheduled' : ($row->ot_type == 'O' ? 'Off Day' : 'Holiday') !!}</td>--}}
                        ...
                        {{--<td width="35px" style="border-bottom-width:1px; font-size:8pt; text-align: center">{!! $row->actual_overtime_hour !!}</td>--}}
                        {{--<td width="100px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! $row->reason !!}</td>--}}

                        {{--<td width="70px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! $row->user->name !!}</td>--}}
                        {{--<td width="70px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! $row->approver->name ?? ' '!!}</td>--}}
                        {{--<td width="70px" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! $row->finalize->name ?? ' ' !!}</td>--}}
                    {{--</tr>--}}
            ...
            {{--<tfoot>--}}
            {{--<tr>--}}
                {{--<td colspan="2" style="border-bottom-width:1px; font-size:8pt; text-align: left">Employee Total</td>--}}
                {{--<td colspan="2" style="border-bottom-width:1px; font-size:8pt; text-align: left">{!! $subtotal !!} Hours</td>--}}
            {{--</tr>--}}
            {{--</tfoot>--}}
