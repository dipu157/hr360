                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="form-group row required">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php echo Form::select('pr_district',$districts,null,array('id'=>'pr_district','class'=>'form-control')); ?>
                                                ...
                                                <div class="form-group row required">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php echo Form::select('pr_post_code',$posts,null,array('id'=>'pr_post_code','class'=>'form-control')); ?>
                                                ...
                                                <div class="form-group row required">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php echo Form::select('pm_district',$districts,null,array('id'=>'pm_district','class'=>'form-control')); ?>
                                                ...
                                                <div class="form-group row required">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php echo Form::select('pm_post_code',$posts,null,array('id'=>'pm_post_code','class'=>'form-control')); ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" name="m_address" cols="50" rows="2" id="m_address"><?php echo $company->name; ?> <?php echo $company->address; ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php echo Form::select('m_district',$districts, $dhaka->district, array('id'=>'m_district','class'=>'form-control')); ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php echo Form::select('m_post_code',$posts,$dhaka->post_code,array('id'=>'m_post_code','class'=>'form-control')); ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="form-group row required">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php echo Form::select('gender',['M' => 'Male', 'F' => 'Female','O'=>'Others'],null,array('id'=>'gender','class'=>'form-control')); ?>
                                                ...
                                                <div class="form-group row required">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php echo Form::select('religion_id',$religions,null,array('id'=>'religion_id','class'=>'form-control')); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <?php echo Form::select('designation_id',$designations,null,array('id'=>'designation_id','class'=>'form-control')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="maxl">
                                                            <label class="radio inline">
                                                                <input type="radio" id="transport-y" name="transport" value="<?php echo 1; ?>">
                                                                <span style="color: #0a0a0a">Yes</span>
                                                            </label>
                                                            <label class="radio inline">
                                                                <input type="radio" id="transport-n" name="transport" value="<?php echo 0; ?>" checked>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <?php echo Form::selectRange('period', 0, 12,6,array('id'=>'period','class'=>'form-control')); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="maxl">
                                                            <label class="radio inline">
                                                                <input type="radio" id="overtime-y" name="overtime" value="<?php echo 1; ?>">
                                                                <span style="color: #0a0a0a">Yes</span>
                                                            </label>
                                                            <label class="radio inline">
                                                                <input type="radio" id="overtime-n" name="overtime" value="<?php echo 0; ?>" checked>
                                                                <span style="color: #0a0a0a">No</span>
                                                            </label>
                                                        </div>
                                                    </div>
