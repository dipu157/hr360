        ...
        <div class="row justify-content-left">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('attendance/onDutyIndex')); ?>" >
                            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <form class="form-inline" method="get" action="<?php echo e(route('attendance/onDutyIndex')); ?>">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-responsive table-striped">
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo $row->professional->personal->full_name; ?> <br/><?php echo $row->professional->employee_id; ?></td>
                                    <td><?php echo \Carbon\Carbon::parse($row->from_date)->format('d-m-Y'); ?> To <?php echo \Carbon\Carbon::parse($row->to_date)->format('d-m-Y'); ?></td>
                                    <td><?php echo $row->duty_place; ?></td>
                                    <td><button type="submit" id="duty-data-<?php echo $i; ?>" value="<?php echo $row->id; ?>" class="btn btn-duty-delete btn-danger btn-sm"><i class="fa fa-trash"></i></button></td>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $(document).on('click', '.form-control.typeahead', function() {
            ...
            var autocomplete_path = "<?php echo e(url('autocomplete/employeeNameId')); ?>";
