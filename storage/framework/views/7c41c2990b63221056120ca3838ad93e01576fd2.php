<div id="employee-photo-upload" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="employee-photo-upload-Label">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="image-form" role="form" method="POST" action="<?php echo url('employee/image/save'); ?>" accept-charset="UTF-8" enctype="multipart/form-data">
