                            ...
                            <div class="card text-primary bg-gray border-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group mb-3">
                                                <?php echo Form::select('session_id',['M'=>'MORNING','E'=>'EVENING','N'=>'NIGHT'], null,['id'=>'session_id', 'class'=>'form-control']); ?>
                                            ...
                                            <div class="form-group">
                                                <div class="maxl">
                                                    <label class="radio inline">
                                                        <input type="radio" id="end_next_day-y" name="end_next_day" value="<?php echo 1; ?>">
                                                        <span style="color: #0a0a0a">Yes</span>
                                                    </label>
                                                    <label class="radio inline">
                                                        <input type="radio" id="end_next_day-n" name="end_next_day" value="<?php echo 0; ?>" checked>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group mb-3">
                                                <input type="text" name="effective_from" id="effective_from" class="form-control" required readonly value="<?php echo \Carbon\Carbon::now()->format('d-m-Y'); ?>">
                                            </div>
                                        </div>
                                    </div>
