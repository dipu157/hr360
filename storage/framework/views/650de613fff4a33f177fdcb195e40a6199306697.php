                                            ...
                                            <div class="form-group">
                                                <div class="maxl">
                                                    <label class="radio inline">
                                                        <input type="radio" id="end_next_day-y-for-update" name="end_next_day" value="<?php echo 1; ?>">
                                                        <span style="color: #0a0a0a">Yes</span>
                                                    </label>
                                                    <label class="radio inline">
                                                        <input type="radio" id="end_next_day-n-for-update" name="end_next_day" value="<?php echo 0; ?>">
