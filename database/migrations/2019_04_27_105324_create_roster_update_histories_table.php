...
class CreateRosterUpdateHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('roster_update_histories');
    }
}
